...
{
    {
        ...
        //RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.5f, 0.9f, 0.2f));
    ...
    //    // TODO(student): Add or change the object colors
    //    RenderSimpleMesh(meshes["sphere2"], shaders["LabShader"], modelMatrix);
    //    //RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.5f, 0.9f, 0.2f));
...

    {
        ...
        //RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.4f, 0.1f, 0.4f));
...

    {
        ...
        //RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.2f, 0.5f, 0.0f));
    }
    ...
    // Render ground
    {
        ...
        //RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0, 0.5f, 0));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint cut_off = glGetUniformLocation(shader->program, "cut_off");
    glUniform1f(cut_off, cutoffAngle);
