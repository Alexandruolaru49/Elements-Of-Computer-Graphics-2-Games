...
void Lab1::Init()
{
    ...
    // no matter how many times we want to draw this mesh.
    {
        ...
        // Added bunny mesh
        Mesh* bunny_mesh = new Mesh("bunny");
        bunny_mesh->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "animals"), "bunny.obj");
        meshes[bunny_mesh->GetMeshID()] = bunny_mesh;
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[s], glm::vec3(posx, posy, posz), glm::vec3(0.05f));
