...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices_tetrahedron
        {
            ...
            VertexFormat(glm::vec3(0.5, 1, 0.5), glm::vec3(1, 0, 0)),*/

            VertexFormat(glm::vec3(0,0,1), glm::vec3(0.3, 0.2, 0.3)),
            VertexFormat(glm::vec3(1,0,0), glm::vec3(0.3, 0.2, 0.3)),
            VertexFormat(glm::vec3(0.5, 1, 0.5), glm::vec3(0.3, 0.2, 0.3)),

            VertexFormat(glm::vec3(1,0,0), glm::vec3(0.1, 0.9, 0.1)),
            VertexFormat(glm::vec3(0,0,0), glm::vec3(0.1, 0.9, 0.1)),
            VertexFormat(glm::vec3(0.5, 1, 0.5), glm::vec3(0.1, 0.9, 0.1)),

            VertexFormat(glm::vec3(0,0,1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0.5, 1, 0.5), glm::vec3(1, 0, 1)),
        ...
        vector<unsigned int> indices_tetrahedron =
        {
        ...
        /*meshes["tethraedron"] = new Mesh("generated tetrahedron");
        meshes["tethraedron"]->InitFromData(vertices_tetrahedron, indices_tetrahedron);*/

        CreateMesh("tethtraedron", vertices_tetrahedron, indices_tetrahedron);
...

    {
        ...
        meshes["square"]->InitFromData(vertices_square, indices_square);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    // EXERCITIUL 3
    RenderMesh(meshes["cube_B"], glm::vec3(1, 1, 0), glm::vec3(1));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tethtraedron"], shaders["VertexColor"], glm::vec3(-3, -1, 0), glm::vec3(1));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], glm::vec3(2, 2, 0), glm::vec3(1));
